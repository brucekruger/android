...
public class DetailsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (this.current != null) {
			...
			tv_Name_Vacancy = (TextView) view
					.findViewById(R.id.tv_name_vacancy);
			...
			img_Logo_Vacancy = (ImageView) view
					.findViewById(R.id.img_logo_vacancy);
			...
			img_Logo_Vacancy.setImageDrawable(Drawable.createFromStream(is,
					"logo"));

			tv_Type_Vacancy = (TextView) view
					.findViewById(R.id.tv_type_vacancy);
			...
			btn_browse.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent i = new Intent(
							...
							WebActivity.class);
					i.putExtra(WebActivity.EXTRA_URL,
							current.getAlternate_url());
					startActivity(i);
				}
			});
		} else {
			view = inflater.inflate(R.layout.empty_item_fragment, container, false);
		}
